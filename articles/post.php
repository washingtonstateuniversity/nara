...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( ! is_singular() ) : ?>
		<div class="article-summary">
			...
			if ( $post->post_excerpt ) {
				echo esc_html( get_the_excerpt() ) . ' <a href="' . esc_html( get_permalink() ) . '"><span class="excerpt-more-default">&raquo; More ...</span></a>';
	...
	if ( has_category() ) {
		...
		foreach ( get_the_category() as $category ) {
			echo '<dd><a href="' . esc_html( get_category_link( $category->cat_ID ) ) . '">' . esc_html( $category->cat_name ) . '</a></dd>';
		}
		echo '</dl>';
	}
	...
	if ( has_tag() ) {
		...
		foreach ( get_the_tags() as $tag ) {
			echo '<dd><a href="' . esc_html( get_tag_link( $tag->term_id ) ) . '">' . esc_html( $tag->name ) . '</a></dd>';
		}
		echo '</dl>';
	}
