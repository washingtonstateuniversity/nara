		...
		<div class="nara-youtube-wrapper"<?php if ( $atts['thumbnail'] ) { ?> style="background-image: url(<?php echo esc_url( $atts['thumbnail'] ); ?>);"<?php } ?>>
			...
			<div class="nara-youtube-close stop-<?php echo esc_attr( $atts['video_id'] ); ?>">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000">
					<path d="M896.6 26L500 422.6 103.4 26C82 4.7 47.4 4.7 26 26c-21.4 21.4-21.4 56 0 77.4L422.6 500 26 896.6c-21.4 21.4-21.4 56 0 77.4 21.4 21.4 56 21.4 77.4 0L500 577.4 896.6 974c21.4 21.4 56 21.4 77.4 0 21.4-21.4 21.4-56 0-77.4L577.4 500 974 103.4c21.4-21.4 21.4-56 0-77.4C952.6 4.7 918 4.7 896.6 26L896.6 26z"/>
				</svg>
			</path>
		</div>
		<?php
