<footer role="footer">
  <div class="support">
    ...
    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/wsu-cougar-head.png" alt="Washington State University Cougar head" height="50" width="56"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/usda-logo.png" alt="USDA" height="50" width="68">
  </div>
  <div class="commons">
